local string_en = {
    ...
    how_to_earn_coins = [[
        ...
        <p>1. 300 coins will be given to you as a reward when you enter our system for the first time.</p>
        <p>2. You need to invest some coins to get access to those lesson packages. And after finishing the learning of each package, you will get a reward of coins.</p>
    ]],
    invinter_tips = [[
